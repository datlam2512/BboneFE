...
function ProductTableView() {
  ...
  const showAddModal = () => {
    setNewProductData({ Id: 0, nameproduct: '', descriptionproduct: '', Price: 0, Quantity: 0, CategoryId: 1, MaterialId: 1, Level: '' });
    ...
    },
    {
      ...
      render: (text, record) => (
        <>
          ...
          <Button type="link" danger onClick={() => setDeleteModalVisible(true)}>Xóa</Button>
          <Modal
            title="Xác nhận xóa"
  ...
  return (
    <div className="container mx-auto py-5">
      <Button type="primary" onClick={showAddModal} className='w-[150px]'>Thêm sản phẩm</Button>
      <Table 
        ...
        <Form layout="vertical">
          ...
          <Form.Item label="Tên sản phẩm">
            <Input 
              ...
              onChange={e => setNewProductData({ ...newProductData, nameproduct: e.target.value })} 
            />
          </Form.Item>
          <Form.Item label="Mô tả sản phẩm">
            <Input 
              value={newProductData.descriptionproduct} 
              onChange={e => setNewProductData({ ...newProductData, descriptionproduct: e.target.value })} 
            />
          </Form.Item>
          <Form.Item label="Giá">
            <Input 
          ...
          <Form.Item label="Cấp độ">
            <Input 
              ...
              onChange={e => setNewProductData({ ...newProductData, Level: e.target.value })} 
            />
          </Form.Item>
        </Form>
      </Modal>
